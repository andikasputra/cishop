      ...
      <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br>
              <form method="post" action="<?= site_url('admin/master/brands/edit_process/'.$detail['brand_id']) ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">

                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="brand_name">Name <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="brand_name" name="brand_name" required="required" class="form-control col-md-7 col-xs-12" value="<?= set_value('brand_name', $detail['brand_name']) ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="brand_description" name="brand_description" required="required" class="form-control col-md-7 col-xs-12"><?= set_value('brand_description', $detail['brand_description']) ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <img src="<?= base_url('resource/images/brand-icon/'.$detail['brand_logo']) ?>" height="100px">
                    <input id="brand_logo" name="brand_logo" class="form-control col-md-7 col-xs-12" type="file" accept="image/*">
                    <input type="hidden" name="brand_logo" value="<?= set_value('brand_logo', $detail['brand_logo']) ?>">
                  </div>
                </div>
