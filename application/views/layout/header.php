	...
	<div class="header">
		...
		<div class="container">
			...
			<div class="head-top">
				...
				<div class="col-sm-7 col-md-offset-2 h_menu4">
					<nav class="navbar nav_bottom" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav nav_1">
								<li><a class="color" href="<?= site_url() ?>">Home</a></li>
											...
											<div class="col1">
												<div class="h_nav">
													<ul>
														...
														<li><a href="<?= site_url('brands/detail/'.$brand['brand_slug']) ?>"><?= $brand['brand_name'] ?></a></li>
														<?php endforeach; ?>
													</ul>	
												</div>							
											</div>
					...
					<ul class="heart">
						...
						<div class="cart box_1">
							<a href="<?= site_url('cart') ?>">
								...
								<p><a href="<?= site_url('cart/empty_cart') ?>" class="simpleCart_empty">Empty Cart</a></p>
